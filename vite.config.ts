    ...
    VitePWA({
      ...
      workbox: {
        runtimeCaching: [
          ...
          {
            // Supabase Storage images - StaleWhileRevalidate is good for likely immutable but potentially updateable content
            // Changed maxEntries to 100 and duration to 30 days
